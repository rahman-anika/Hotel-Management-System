...
<body>
  ...
  <div id="full">
   ...
   <div style="background-image:url('img/meeting1.jpg');background-size:100% 920px; width:100%; height:920px;">
	...
	<div id="banner"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	  ...
	  <div id="form">
	     ...
	     <form action="mroom.php" method="post">
	   ...
	   if(isset($_POST['submit']))
	   {
		  ...
		  if(mysqli_query($a,"insert into mroom(rno,rtype,rprice,status)
