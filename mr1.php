...
<body>
	 ...
	 <table style="color:#AFA; font-size:40px; ">
	     ...
	     <?php
		    ...
		    /* $q1="select * from room where status='Available' AND rtype='$rtype'";
		     ...
		     $q1="select * from mroom WHERE status='Available' AND rtype='$rtype'"; 
	   ...
	   <tr>
		 ...
		 <td><a style="width:160px;height:60px; border-radius:20px; opacity:0.7;" href="mbook.php? rno=<?php echo $rno; ?>" >Book My Meeting</a></td>
        </tr>
  ...
  //$rno=$_GET['rno'];
    ...
    if( $name!=''){
		 if(mysqli_query($a,"insert into mform(name,rid,address,country,email,cidate,members,idno)
				value('$name','$rid','$address','$country','$email','$coin','$members','$idno')"))
				{
